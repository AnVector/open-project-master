...
public class GridLayoutManagerTV extends GridLayoutManager {
	...
	private View mSelectedView;//当前选中的ItemView
//	private View mPreView;//前一个View
	...
	@Override
	public boolean requestChildRectangleOnScreen(final RecyclerView parent, final View child, Rect rect, boolean immediate) {
//		OPENLOG.D("requestChildRectangleOnScreen");
		...
		//
		this.mDy = dy;
//		mPreView =mSelectedView;
		mSelectedView = child;
/*		if(mPreView!=null){
			Log.e("postion","pre_position="+getPosition(mPreView));
		}
		Log.e("postion","cur_position="+getPosition(mSelectedView));*/
